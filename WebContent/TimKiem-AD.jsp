...
<div class="container">
  ...
  <!-- /.container-fluid -->
		...
		<form method="post" name="frm" action="SearchAD">
		<div><label>Tìm kiếm theo? <p></p><select class="form-control " name="timtheo" id ="timtheo"onchange="onCBChange(this);"></label>
					<option value="mdt" name="timtheo">Mã đề tài </option>
					<option value="mgv" name="timtheo">Mã giáo viên</option>
					<option value="mk"name="timtheo" >Mã khoa</option>
					</select>
			</div>
			<p></p>
                            <div class="input-group" >
      <input type="text" class="form-control" placeholder="Nhập mã"  name="noidungtim"  id="noidungtim">
      <span class="input-group-btn">
        <button class="btn btn-default" type="submit" id="btnTim" value="Search">Tìm</button>
      </span>
    ...
    Chức năng:
    <br>
    <a href="DangLuanVan-AD.jsp"><button type="button" class="btn btn-success">Thêm</button></a>
   <a href="DangLuanVan-AD.jsp"><button type="button" class="btn btn-primary">Sửa</button></a>
    <a href="#openXoa"><button type="button" class="btn btn-danger">Xóa</button></a>
    <p></p>
    <a href="#openChiTiet"><button type="button" class="btn btn-info">Xem chi tiết</button></a>
			<option></option>
