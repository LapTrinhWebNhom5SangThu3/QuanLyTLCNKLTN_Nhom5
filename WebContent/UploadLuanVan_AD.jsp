...
String tengvpb = request.getParameter("TenGVPB");
String diem = request.getParameter("Diem");
String namhoc = request.getParameter("NamHoc");
String ndfile = request.getParameter("File");
Class.forName("com.mysql.jdbc.Driver");
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydataweb",
        "root", "Lehaidang2411");
Statement st = con.createStatement();
 int a = st.executeUpdate("insert into tlcn (MaDT,TenDT,TenSV,TenGVHD,Khoa,TenGVPB,Diem,NamHoc,File) values (' " +madt +" ',' "+tendt+" ',' " + tensv + " ' ,' " + tengvhd+" ',' " +tenkhoa +" ',' "+tengvpb+" ',' " + diem + " ','"+namhoc+"',' " + ndfile+" ')");
