    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           if(chon.equals("mdt")){
                 ...
                 RequestDispatcher view = request.getRequestDispatcher("/TimKiem-SV.jsp");
           ...
           else if(chon.equals("msv")){
        	   String pid = request.getParameter("noidungtim");
          	 ArrayList al = null;
               ArrayList pid_list = new ArrayList();
               String query = "select MaDT,TenDT,TenSV,MSSV,TenGVHD,Khoa FROM tlcn  where MSSV='"+ pid+"'";
